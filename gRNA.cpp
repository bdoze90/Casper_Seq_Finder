...
unsigned long long gRNA::insertSequence(long index, int chr, int pamsize, bool sensestrand, bool dir, std::string seq, int score, short five, short seedsize, short three) {
    PAMlocation = index;
	if (!sensestrand) {
        PAMlocation *= -1;
    }
