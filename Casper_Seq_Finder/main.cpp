...
int main() {
    //int argc = 10;
    std::vector<std::string> argv = {"Executable","saCas9","NNGRRT", "TRUE", "FALSE", "4","16","0","testfile","/Users/brianmendoza/Desktop/","/Users/brianmendoza/Dropbox/CASPER/CASPERinfo","/Users/brianmendoza/Downloads/pde.fna", "Escherichia coli", "notes_go_here"};
    pamEval P;
    P.PAMID = argv[1];
    P.pam = argv[2];
